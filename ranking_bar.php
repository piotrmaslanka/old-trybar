...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/ranking_bar.css">
...
<?php $page=4; include 'moduly/banner.php'; ?>    
				...
				<td id="content_area_content" rowspan="3">
					...
					<div id="content_area_content_c">	<!-- glowny kontener -->									
						...
						<div id="content_area_limiter">
							...
							<div class="msg">
								...
								<div class="fota">
									...
									if($bar->doHasPhoto()==false)
									{
									echo'<img src="gfx/miniatura_bar_brak_50x50.jpg">';
									}
									else echo'<img src="uploads/50x50/'.$bar->getFirstPhoto().'.jpg">';
									echo'
									</a>
								</div>
								<div class="ocena">'.$bar->avgMark().'</div>
								<div class="nazwa">
									<div class="username">
										<a href="bar.php?id='.$bar->id.'">'.$bar->name.'</a>
									</div>
									<div class="townname">'.$bar->city.'</div>
								</div>
							</div>';
							$pozycja=$pozycja+1;
							}
						...
						<div id="bt_stuff">
							...
							if($strona>1)
							{
							echo'<a href="ranking_bar.php?strona='.$poprzednia.'"><div class="left"></div></a>';
							echo'<a href="ranking_bar.php?strona=1"><div class="bx">1</div></a>';
							if($kropki==false)
							{
							...
							echo'<a href="ranking_bar.php?strona='.$strona.'"><div class="bx">'.$strona.'</div></a>';	
							if($strony>$strona)
							{
							if($kropki==false)
							{
							...
							echo'<a href="ranking_bar.php?strona='.$strony.'"><div class="bx">'.$strony.'</div></a>';
							echo'<a href="ranking_bar.php?strona='.$nastepna.'"><div class="right"></div></a>';
							}
							?>
							</div>
						</div>
